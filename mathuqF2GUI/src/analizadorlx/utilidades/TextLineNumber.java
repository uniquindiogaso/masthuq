...
/**
 * Esta clase mostrará números de línea para un componente de texto relacionado.
 * El componente de texto debe utilizar la misma altura de línea para cada
 * línea. TextLineNumber admite las líneas envueltas y resaltará el número de
 * línea de la línea actual en el componente de texto.
 *
 * Esta clase fue diseñada para ser utilizada como un componente agregado al
 * encabezado de fila de un JScrollPane.
 *
 ...
 * @since 2017
 *
 * ver https://tips4java.wordpress.com/2009/05/23/text-component-line-number/
 */
